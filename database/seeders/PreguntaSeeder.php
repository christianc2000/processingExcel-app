...
class PreguntaSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $pregunta->fuentes()->attach([1,2,4,5],[]);
        $pregunta = Pregunta::create([
        ...
        $pregunta->fuentes()->attach([1,2,3,4,5],[]);
        $pregunta = Pregunta::create([
